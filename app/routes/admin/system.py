...
def manual_lending():
    ...
    try:
        ...
        # Aktuelle Verbrauchsmaterial-Ausgaben (letzte 30 Tage) via LendingService
        recent_usages = LendingService.get_recent_consumable_usage(limit=100, days=30, only_outputs=True)
        for usage in recent_usages:
            current_lendings.append({
                'item_name': usage.get('consumable_name', 'Unbekannt'),
