...
class AdminEmailTemplatesService:
    ...
    def save_template_mappings(mapping: Dict[str, str]) -> Tuple[bool, str]:
        try:
            ...
            return False, f'Fehler beim Speichern der Zuordnungen: {e}'
    ...
    def get_template(template_id: str) -> Optional[Dict[str, Any]]:
        try:
            ...
            logger.error(f"Fehler beim Laden der E-Mail-Vorlage {template_id}: {e}")
            return None
    ...
    def get_template_by_key(template_key: str) -> Optional[Dict[str, Any]]:
        try:
            ...
            logger.error(f"Fehler beim Laden der E-Mail-Vorlage mit key={template_key}: {e}")
            return None
    ...
    def create_template(data: Dict[str, Any]) -> Tuple[bool, str, Optional[str]]:
        try:
            ...
            logger.error(f"Fehler beim Erstellen der E-Mail-Vorlage: {e}")
    ...
    def update_template(template_id: str, data: Dict[str, Any]) -> Tuple[bool, str]:
        try:
            ...
            logger.error(f"Fehler beim Aktualisieren der E-Mail-Vorlage {template_id}: {e}")
    ...
    def delete_template(template_id: str) -> Tuple[bool, str]:
        try:
            ...
            logger.error(f"Fehler beim Löschen der E-Mail-Vorlage {template_id}: {e}")
    ...
    def send_test_email(template_id: str, recipient_email: str) -> Tuple[bool, str]:
        try:
            ...
            try:
                ...
                logger.warning(f"Test-Rendering fehlgeschlagen, sende Rohtext: {e}")
                subject = subject_tpl
    ...
    def render_template_by_key(template_key: str, context: Dict[str, Any]) -> Optional[Dict[str, Optional[str]]]:
        ...
        try:
            ...
            logger.error(f"Fehler beim Rendern der E-Mail-Vorlage '{template_key}': {e}")
            return None
    ...
    def ensure_default_templates() -> Dict[str, Any]:
        ...
        defaults: List[Dict[str, Any]] = [
            ...
            {
                'name': 'Willkommensmail neuer Nutzende (Standard)',
                'key': 'user_welcome',
                'subject': 'Scandy – Ihre Zugangsdaten',
                'html_content': (
                    """
                    <h2>Willkommen bei Scandy!</h2>
                    <p>Hallo {{ firstname }}, Ihr Nutzendekonto wurde erstellt.</p>
                    <ul>
                        <li><strong>Nutzendename:</strong> {{ username }}</li>
