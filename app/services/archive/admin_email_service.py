...
class AdminEmailService:
    ...
    def test_email_configuration() -> Tuple[bool, str]:
        ...
        try:
            ...
            if not admin_users:
                return False, "Keine Admin-Nutzende gefunden"
            
            admin_email = admin_users[0].get('email')
            if not admin_email:
                return False, "Admin-Nutzende hat keine E-Mail-Adresse"
    ...
    def send_low_stock_notification(consumable_data: Dict[str, Any]) -> Tuple[bool, str]:
        ...
        try:
            ...
            if not admin_users:
                return False, "Keine Admin-Nutzende für Benachrichtigung gefunden"
    ...
    def send_overdue_notification(lending_data: Dict[str, Any]) -> Tuple[bool, str]:
        ...
        """
        try:
            # Hole Werkzeug und Mitarbeitende
            ...
            if not tool or not worker:
                return False, "Werkzeug oder Mitarbeitende nicht gefunden"
            ...
            Mitarbeitende: {worker.get('firstname', '')} {worker.get('lastname', '')}
    ...
    def get_email_statistics() -> Dict[str, Any]:
        ...
        try:
            ...
            # Zähle Nutzende mit E-Mail-Adressen
