...
class EmailService:
    ...
    def send_password_reset_email(user_email: str, reset_token: str, username: str) -> bool:
        ...
        Args:
            user_email: E-Mail-Adresse des Nutzendes
    ...
    def send_new_user_email(user_email: str, username: str, password: str, firstname: str) -> bool:
        """
        Sendet E-Mail mit Zugangsdaten für neue Nutzende
        
        Args:
            user_email: E-Mail-Adresse des Nutzendes
            username: Nutzendename
            password: Generiertes Passwort
            firstname: Vorname des Nutzendes
        ...
        try:
            ...
            if rendered and (rendered.get('html_content') or rendered.get('text_content')):
                ...
                try:
                    ...
                    if not _contains_pwd(html_content):
                        extra_html = (
                            f"<hr><p><strong>Nutzendename:</strong> {username}<br>"
            ...
            <p>Hallo {{ firstname }},</p>
            <p>Ihr Nutzendekonto wurde erfolgreich erstellt.</p>
            ...
            logger.error(f"Fehler beim Senden der neuen Nutzende-E-Mail: {str(e)}")
            return False
    ...
    def send_lending_notification_email(user_email: str, lending_data: Dict[str, Any], action: str) -> bool:
        ...
        try:
            ...
            <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin: 15px 0;">
                ...
                <p><strong>Mitarbeitende:</strong> {{ lending.worker_name }}</p>
