...
def index():
    ...
    try:
        ...
        logger.error(f"Fehler beim Laden der Kantinenplan-Seite: {str(e)}")
...
def embed():
    ...
    try:
        ...
        logger.error(f"Fehler beim Rendern der Canteen-Embed-Ansicht: {str(e)}")
...
def embed_today():
    ...
    try:
        ...
        logger.error(f"Fehler beim Rendern der Canteen-Embed-Today-Ansicht: {str(e)}")
...
def canteen_status():
    ...
    try:
        ...
        logger.error(f"Fehler beim Abrufen des Kantinenplan-Status: {str(e)}")
...
def api_today():
    ...
    try:
        ...
        logger.error(f"API-Fehler (today): {str(e)}")
        return jsonify({'success': False, 'error': 'Ein interner Fehler ist aufgetreten.'}), 500
...
def api_status():
    ...
    try:
        ...
        logger.error(f"Status-API-Fehler: {str(e)}")
...
def test_save():
    ...
    try:
        ...
        logger.error(f"Fehler in test_save: {str(e)}")
        return jsonify({
            'success': False,
            'error': 'Ein interner Fehler ist aufgetreten.'
        }), 500
...
def debug_request():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            logger.info(f"JSON Data: None (not JSON content-type) - {str(e)}")
