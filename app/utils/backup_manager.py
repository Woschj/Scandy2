...
class BackupManager:
        ...
        for field in datetime_fields:
            if field in doc and isinstance(doc[field], str):
                try:
                    ...
                    logger.warning(f"Fehler bei Datumskonvertierung: {str(e)}")
            ...
            if '__type__' in obj:
                if obj['__type__'] == 'datetime':
                    ...
                    try:
                        ...
                        logger.warning(f"Fehler bei ObjectId-Konvertierung: {str(e)}")
    ...
    def _detect_old_backup_format(self, backup_data):
        ...
        try:
            ...
            logger.error(f"Fehler beim Erkennen des Backup-Formats: {str(e)}")
            return {
                'is_old_format': True,
                'version_estimate': 'unknown',
                'collections_found': [],
        ...
        try:
            ...
            for collection in collections_to_backup:
                try:
                    ...
                    print(f"Fehler beim Sichern von {collection}: {str(e)}")
        ...
        try:
            ...
            if temp_path and temp_path.exists():
                try:
                    ...
                    print(f"Fehler beim Löschen der temporären Datei: {str(e)}")
        ...
        try:
            ...
            for collection, documents in data_section.items():
                ...
                try:
                    ...
                    if documents:
                        ...
                        for doc in documents:
                            try:
                                ...
                                logger.error(f"Fehler bei Dokument-Konvertierung in {collection}: {str(e)}")
                    ...
                    logger.error(f"❌ Fehler beim Wiederherstellen von {collection}: {str(e)}")
            ...
            try:
                ...
                logger.error(f"Fehler bei automatischen Dashboard-Fixes: {str(e)}")
            ...
            print(f"Fehler beim Wiederherstellen aus Datei: {str(e)}")
            return False
    ...
    def _fix_category_inconsistency(self):
        ...
        try:
            ...
            print(f"Fehler beim Beheben der Kategorien-Inkonsistenz: {str(e)}")
    ...
    def _fix_consumable_inconsistencies(self):
        ...
        try:
            ...
            for consumable in consumables:
                ...
                if isinstance(created_at, str):
                    try:
                        ...
                        logger.warning(f"Fehler bei Datumskonvertierung created_at: {str(e)}")
                        pass
                ...
                if isinstance(updated_at, str):
                    try:
                        ...
                        logger.warning(f"Fehler bei Datumskonvertierung updated_at: {str(e)}")
                        pass
            ...
            for usage in usages:
                ...
                if isinstance(used_at, str):
                    try:
                        ...
                        logger.warning(f"Fehler bei Datumskonvertierung used_at: {str(e)}")
                        pass
            ...
            logger.error(f"Fehler beim Beheben der Verbrauchsgüter-Inkonsistenzen: {str(e)}")
        ...
        try:
            ...
            for backup in all_backups:
                try:
                    ...
                    print(f"Fehler beim Löschen von {backup.name}: {str(e)}")
            ...
            print(f"Fehler beim Aufräumen alter Backups: {str(e)}")
    ...
    def create_native_backup(self):
        ...
        try:
            ...
            print(f"Fehler beim Erstellen des nativen Backups: {str(e)}")
            return None
    ...
    def restore_native_backup(self, backup_filename):
        ...
        try:
            ...
            print(f"Fehler beim Wiederherstellen des nativen Backups: {str(e)}")
            return False
    ...
    def _python_restore_mongodb(self, mongo_uri: str, bson_dir):
        ...
        try:
            ...
            print(f"❌ Python-Fallback fehlgeschlagen: {str(e)}")
            return False
    ...
    def restore_native_backup_from_upload(self, uploaded_file):
        ...
        try:
            ...
            print(f"Fehler beim Wiederherstellen des nativen Backups aus Upload: {str(e)}")
            return False
    ...
    def list_native_backups(self):
        ...
        try:
            ...
            print(f"Fehler beim Auflisten der nativen Backups: {str(e)}")
            return []
    ...
    def create_hybrid_backup(self):
        ...
        try:
            ...
            print(f"Fehler beim Erstellen des hybriden Backups: {str(e)}")
            return None
    ...
    def convert_old_backup(self, old_backup_filename):
        ...
        try:
            ...
            print(f"Fehler beim Konvertieren des Backups: {str(e)}")
            return None
        ...
        try:
            ...
            for backup_file in self.backup_dir.glob('*.json'):
                try:
                    ...
                    print(f"Fehler beim Lesen von {backup_file.name}: {str(e)}")
            
            return old_backups
            
        except Exception as e:
            print(f"Fehler beim Auflisten alter Backups: {str(e)}")
            return []
    ...
    def convert_all_old_backups(self):
        ...
        try:
            ...
            print(f"Fehler bei der Massenkonvertierung: {str(e)}")
            return []
