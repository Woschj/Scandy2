...
class IndexOptimizer:
    ...
    def _ensure_tool_indexes():
        ...
        try:
            ...
            logger.error(f"Error optimizing tool indexes: {e}")
    ...
    def _ensure_worker_indexes():
        ...
        try:
            ...
            logger.error(f"Error optimizing worker indexes: {e}")
    ...
    def _ensure_consumable_indexes():
        ...
        try:
            ...
            logger.error(f"Error optimizing consumable indexes: {e}")
    ...
    def _ensure_lending_indexes():
        ...
        try:
            ...
            logger.error(f"Error optimizing lending indexes: {e}")
    ...
    def _ensure_ticket_indexes():
        ...
        try:
            ...
            logger.error(f"Error optimizing ticket indexes: {e}")
    ...
    def _ensure_system_indexes():
        ...
        try:
            ...
            logger.error(f"Error optimizing system indexes: {e}")
...
class QueryOptimizer:
    ...
    def _get_dashboard_statistics_fallback() -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error in fallback dashboard statistics: {e}")
            return {
                'tool_stats': {'total': 0, 'available': 0, 'lent': 0, 'defect': 0},
                'consumable_stats': {'total': 0, 'sufficient': 0, 'warning': 0, 'critical': 0},
                'worker_stats': {'total': 0},
