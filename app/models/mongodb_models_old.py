...
class MongoDBLending:
    ...
    def get_active_by_worker(cls, worker_id: str) -> List[Dict[str, Any]]:
        """Holt alle aktiven Ausleihen eines Mitarbeitendes"""
    ...
    def get_lendings_by_worker(cls, worker_barcode: str) -> List[Dict[str, Any]]:
        """Holt alle Ausleihen eines Mitarbeitendes"""
...
class MongoDBConsumableUsage:
    ...
    def get_by_worker(cls, worker_id: str) -> List[Dict[str, Any]]:
        """Holt alle Verwendungen eines Mitarbeitendes"""
    ...
    def get_usage_by_worker(cls, worker_barcode: str, days: int = 30) -> List[Dict[str, Any]]:
        """Holt den Verbrauch eines Mitarbeitendes"""
...
class MongoDBUser:
    ...
    def get_by_username(cls, username: str) -> Optional[Dict[str, Any]]:
        """Holt einen Nutzende anhand des Nutzendenamens (case-insensitive)"""
...
def create_mongodb_indexes():
    ...
    try:
        ...
        # Mitarbeitende-Indizes (Unique pro Abteilung)
        ...
        # Eindeutige, case-insensitive E-Mail über normalisierte Spalte
        try:
            mongodb.create_index(MongoDBUser.COLLECTION_NAME, 'email_lower', unique=True, sparse=True)
        except Exception:
            # Falls bestehende Duplikate existieren, Index-Erstellung kann fehlschlagen – Logik an höherer Stelle behandeln
